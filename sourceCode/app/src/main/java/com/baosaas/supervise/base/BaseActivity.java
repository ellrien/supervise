...
/**
 * Created by Ellrien on 2015/12/7.
 */
public class BaseActivity extends Activity {
     ...
     * @param msg 自定义消息
     */
    public void showProgress(View view, String msg) {
        if (this != null) {
    ...
    public void showProgress(String title, String message) {
        if (BaseActivity.this != null) {
            progressDlg = new UserDefinedProgressDialog(BaseActivity.this);
            progressDlg.setProgressStyle(ProgressDialog.STYLE_SPINNER);
...
//        if(!this.getActivity().isFinishing() )
     ...
     * @param msg 自定义消息
     */
    public void showProgressClose(String msg, boolean canCancle) {
        if (canCancle) {
            showProgress(msg);
            return;
        }
